...
<div class="menu-form">
  ...
  <div class="row">
          ...
          <div class="tab-content">
            ...
            foreach ($languages as $key => $value):
              ...
              <div class="tab-pane <?php if ($i == 1) echo 'active'; ?>" id="<?= $key ?>" role="tabpanel">
                ...
                <?= $form->field($model, MultilingualHelper::getFieldName('img_text', $key))->textarea(['rows' => '6', 'maxlength' => true]) ?>
              </div>
            <?php endforeach; ?>
          </div>
        </div>
    ...
    <div class="col-md-4">
      <div class="card">
        <div class="card-body">
          <?= $form->field($model, 'status')->dropDownList(\common\models\MenuMain::statuses()) ?>
